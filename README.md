...
```javascript
import gapxsumors from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gapxsumors@v0.3.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gapxsumors/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-gapxsumors/actions/workflows/test.yml?query=branch:v0.3.1
